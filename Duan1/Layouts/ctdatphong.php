...
$endDate = new DateTime($ngaytraa);
   // Tính số ngày giữa hai ngày
    ...
    echo '<script>var errorMessage = "Bạn chưa đăng nhập!";</script';
