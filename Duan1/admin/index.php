                                      ...
                                      case 'thongke':
                                        ...
                                        case 'add_news':
                                            ...
                                            if (isset($_POST['tintuc'])) {
                                                ...
                                                $date = $_POST["date"];
                                                $image_rom=basename($_FILES['image_rom']['name']);
                                                $image_rom_p=basename($_FILES['image_rom_p']['name']);

                                                $target_dir="../uploads/";
                                           $target_file = $target_dir . $image_rom;
                                           $target_file_p = $target_dir . $image_rom_p;

                       
                
                                     if(move_uploaded_file($_FILES["image_rom"]["tmp_name"], $target_file)){
                                          }
                                          if(move_uploaded_file($_FILES["image_rom_p"]["tmp_name"], $target_file_p)){
                                        }
                                            
                                                $sql = "INSERT INTO news (title,title_sub,image_news,image_news_p,content_news,date) VALUES ('$title', '$subtitle','$image_rom','$image_rom_p','$content', '$date')";
                                                pdo_execute($sql);
                                            }
