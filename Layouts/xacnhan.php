...
// }
  if(isset($_GET['email'])){
    $email=$_GET['email'];
    $sql="select * from verification_codes where email='$email' order by id desc";
  ...
  if(isset($load)){
    extract($load);
    if(isset($_POST['nhapmaxacnhan'])){
        $userEnteredCode = $_POST['code'];
        $userEnteredTime = time();
       
        
            if ($userEnteredCode === $code  and ($userEnteredTime - $timestamp) <= 120) {
               
                header("location: doimatkhau.php?email=$email");
            } else {
              $tb="Mã xác thực sai hoặc đã quá thời gian !";
            }
        }
  }
                    ...
                    <div class="row mt-4">
                        <div class="col">
                            <div class="input-email">
                                ...
                                <input type="text" name="code" id="" placeholder="nhập mã xác thực...">
                    ...
                    <div class="row mt-4">
                        <div class="col">
                            ...
                            <div class="input-email">
                                ...
                                <input type="submit" name="nhapmaxacnhan" id="" value="XÁC NHẬN">
